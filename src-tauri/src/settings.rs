...
pub struct ClaudeLaunchConfig {
    ...
    /// 努力水平 (--effort): low, medium, high
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub effort: Option<String>,
    /// 权限模式 (--permission-mode): default, acceptEdits, bypassPermissions, plan
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct AppSettings {
    ...
    /// Claude Code 默认启动配置
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub claude_default_launch_config: Option<ClaudeLaunchConfig>,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            claude_default_launch_config: None,
            webdav_sync: None,
            webdav_backup: None,
...
pub fn get_claude_default_launch_config() -> Option<ClaudeLaunchConfig> {
    settings_store()
        .read()
        .unwrap_or_else(|e| {
            log::warn!("设置锁已毒化，使用恢复值: {e}");
        ...
        .claude_default_launch_config
        .clone()
}

pub fn set_claude_default_launch_config(config: Option<ClaudeLaunchConfig>) -> Result<(), AppError> {
    ...
    settings.claude_default_launch_config = config;
