...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::check_gemini_installed,
            commands::check_opencode_installed,
            commands::check_openclaw_installed,
            commands::check_hermes_installed,
            commands::install_claude_code,
            commands::install_codex,
            commands::install_gemini,
            commands::install_opencode,
            commands::install_openclaw,
            commands::install_hermes,
            // Skills CLI + Anthropic Skills
            commands::check_skills_cli_installed,
            commands::install_skills_cli,
            commands::check_anthropic_skills_installed,
            commands::install_anthropic_skills,
            commands::uninstall_claude_code,
            commands::uninstall_codex,
            commands::uninstall_gemini,
            commands::uninstall_opencode,
            commands::uninstall_openclaw,
            commands::uninstall_hermes,
            commands::uninstall_skills_cli,
            commands::uninstall_anthropic_skills,
            commands::update_claude_code,
            commands::update_codex,
            commands::update_gemini,
            commands::update_opencode,
            commands::update_openclaw,
            commands::update_hermes,
            commands::update_skills_cli,
            commands::update_anthropic_skills,
            // Claude Code launch config
            commands::get_claude_default_launch_config,
            commands::set_claude_default_launch_config,
