...
export const settingsApi = {
  ...
  async checkClaudeInstalled(): Promise<ClaudeInstallStatus> {
    return await invoke("check_claude_installed");
  },
  async checkCodexInstalled(): Promise<ClaudeInstallStatus> {
    return await invoke("check_codex_installed");
  },
  async checkGeminiInstalled(): Promise<ClaudeInstallStatus> {
    return await invoke("check_gemini_installed");
  },
  async checkOpencodeInstalled(): Promise<ClaudeInstallStatus> {
    return await invoke("check_opencode_installed");
  },
  async checkOpenclawInstalled(): Promise<ClaudeInstallStatus> {
    return await invoke("check_openclaw_installed");
  },
  async checkHermesInstalled(): Promise<ClaudeInstallStatus> {
    return await invoke("check_hermes_installed");
  },
  ...
  async installGemini(): Promise<void> {
  ...
  async getClaudeDefaultLaunchConfig(): Promise<ClaudeLaunchConfig | null> {
    return await invoke("get_claude_default_launch_config");
  },

  async setClaudeDefaultLaunchConfig(
    config: ClaudeLaunchConfig | null,
  ): Promise<boolean> {
    return await invoke("set_claude_default_launch_config", { config });
  },
};
...
export interface ClaudeInstallStatus {
  ...
  detection_method: "npm_list" | "path_scan" | "not_found";
