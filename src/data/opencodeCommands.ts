...
const CMD = (
  ...
  descriptionKey: `commands.opencode.${id}.description`,
  usageKey: `commands.opencode.${id}.usage`,
  sessionOnly: true,
...
export const OPENCODE_COMMAND_CATEGORIES: Record<
  CommandCategory,
...
export const OPENCODE_SLASH_COMMANDS: AgentSlashCommand[] = [
  // Session
...
export function opencodeCommandsByCategory(): Map<
  CommandCategory,
  AgentSlashCommand[]
> {
  const map = new Map<CommandCategory, AgentSlashCommand[]>();
  for (const cmd of OPENCODE_SLASH_COMMANDS) {
