...
const CMD = (
  ...
  descriptionKey: `commands.hermes.${id}.description`,
  usageKey: `commands.hermes.${id}.usage`,
  sessionOnly: true,
...
export const HERMES_COMMAND_CATEGORIES: Record<
  CommandCategory,
...
export const HERMES_SLASH_COMMANDS: AgentSlashCommand[] = [
  // Session
...
export function hermesCommandsByCategory(): Map<
  CommandCategory,
  AgentSlashCommand[]
> {
  const map = new Map<CommandCategory, AgentSlashCommand[]>();
  for (const cmd of HERMES_SLASH_COMMANDS) {
