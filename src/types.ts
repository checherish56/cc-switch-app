...
// ============================================================================
// Claude Code settings.json configuration (v3.15.0+)
// ============================================================================
...
export interface ClaudePermissions {
  defaultMode?: PermissionMode | string;
  allow?: string[];
  deny?: string[];
  ask?: string[];
...
export interface ClaudeSettingsReadResult {
  ...
  managedTopLevelKeys: string[];
  configPath: string;
  exists: boolean;
}

export interface ClaudeSettingsWriteOutcome {
  backupPath?: string;
}
